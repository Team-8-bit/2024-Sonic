...
object AutoConstants {
    ...
    val topCenterNotePath get() = Pose2d(5.635, 6.381, Rotation2d(Math.PI)).applyFlip()
    val topCenterNoteShotPose get() = Pose2d(2.944, 6.375, Rotation2d(Math.PI)).applyFlip()
